...
# Prompt 2+3 combined - Batch Interview (replaces both)
...
{{
  "answers": [
    {{
      "question": "...",
      "revised_persona_answer": "3-4 sentence human response",
...
# Prompt 4+5 combined - Live Reply (replaces both)
...
**OUTPUT FORMAT JSON:**
{{
  "response": "Final 3-4 sentence human interview-style reply"
}}
"""
